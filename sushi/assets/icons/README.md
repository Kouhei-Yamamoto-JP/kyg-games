...
Transparent 256×256 PNG icons for the rotating-sushi browser game.
Generated with Codex `gpt-5.6-luna` + built-in `image_gen` (realistic sushi food style, readable as small UI icons).

| File | English | Japanese |
|------|---------|----------|
| `shari.png` | Sushi rice ball | シャリ |
| `nori.png` | Nori seaweed sheet | 海苔 |
| `nigiri-maguro.png` | Tuna nigiri | まぐろ握り |
| `nigiri-salmon.png` | Salmon nigiri | サーモン握り |
| `nigiri-ebi.png` | Shrimp nigiri | えび握り |
| `nigiri-tamago.png` | Egg nigiri | たまご握り |
| `gunkan-ikura.png` | Ikura gunkan | いくら軍艦 |
